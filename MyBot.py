...
def get_ship_command(ship):
    ...
    planets = [planet for distance in entities_by_distance for planet in entities_by_distance[distance] if isinstance(planet, hlt.entity.Planet)]
    ...
    for non_taken_planet in planets:
